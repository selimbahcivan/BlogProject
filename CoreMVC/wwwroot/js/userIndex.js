    ...
    $(function () {
        ...
        placeHolderDiv.on('click',
            ...
            function (event) {
                ...
                const dataToSend = new FormData(form.get(0));   /*form.serialize(); -> IFormFile tipi serialize olmayacağı için ajax işlemini değiştirdik.*/
                $.ajax({
                    url: actionUrl,
                    type: 'POST',
                    data: dataToSend,
                    ...
                    success: function (data) {
                        ...
                        if (isValid) {
                            ...
                            ]).node(); // node tableRow'u seçtiriyor.
                            const jqueryTableRow = $(newTableRow);
